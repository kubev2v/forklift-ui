...
const hook1 = {
  ...
  metadata: {
    ...
    selfLink: '/apis/forklift.konveyor.io/v1beta1/namespaces/openshift-migration/hooks/hooktest-01',
...
const hook2 = {
  ...
  metadata: {
    ...
    generation: 1,
    resourceVersion: '30825024',
    selfLink: '/apis/forklift.konveyor.io/v1beta1/namespaces/openshift-migration/hooks/hooktest-02',
